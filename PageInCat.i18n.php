 ...
 */
$messages['ast'] = array(
	'pageincat-desc' => "Amiesta una función d'analís <code><nowiki>{{#incat:...}}</nowiki></code>, pa determinar si la páxina actual ta nuna categoría especificada",
...
$messages['be-tarask'] = array(
	...
	'pageincat-wrong-warn' => "'''Увага:''' функцыяй <code><nowiki>{{#incat:...}}</nowiki> {{PLURAL:$2|1=катэгорыя «$1» была вызначаная|катэгорыі $1 былі вызначаныя}} некарэктна, таму папярэдні прагляд можа быць няправільным. Захаваная вэрсія старонкі мусіць адлюстроўвацца правільна.", # Fuzzy
	'pageincat-very-wrong-warn' => "'''Увага:''' функцыяй <code><nowiki>{{#incat:...}}</nowiki> {{PLURAL:$2|1=катэгорыя «$1» была вызначаная|катэгорыі $1 былі вызначаныя}} некарэктна, таму папярэдні прагляд можа быць няправільным. Гэта магло быць выклікана ўключэньнем катэгорыяў унутры <code><nowiki>{{#incat:...}}</nowiki></code>, што магло выліцца ў няправільнае адлюстраваньне.", # Fuzzy
);
 ...
 */
$messages['lb'] = array(
	'pageincat-desc' => 'Setzt eng Parserfunktioun  <code><nowiki>{{#incat:...}}</nowiki></code> derbäi fir festzestellen ob déi aktuell Säit an enger spezifescher Kategorie dran ass',
...
$messages['ru'] = array(
	...
	'pageincat-wrong-warn' => "'''Предупреждение:''' {{PLURAL:$2|1=категория $1 была  определена|категории $1 были определены}} <code><nowiki>{{#incat:…}}</nowiki></code> неправильно, и в результате этот предварительный просмотр может быть неверными. Сохраненная версия этой страницы должна будет отображаться в правильном виде.", # Fuzzy
	'pageincat-very-wrong-warn' => "'''Предупреждение:''' {{PLURAL:$2|1=категория $1 была  определена|категории $1 были определены}} <code><nowiki>{{#incat:…}}</nowiki></code> неправильно, и в результате этот предварительный просмотр может быть неверными.
Это может быть вызвано включением категорий внутрь выражений <code><nowiki>{{#incat:…}}</nowiki></code> и может привести к неправильному отображению.", # Fuzzy
);
...
$messages['uk'] = array(
	...
	'pageincat-wrong-warn' => "'''Увага:''' функцією <code><nowiki>{{#incat:...}}</nowiki></code> {{PLURAL:$2|1=категорію $1|категорії $1 were}} було визначено некоректно, тому результат у попередньому перегляді може бути неправильним. Збережена версія повинна відображати все коректно.",
	'pageincat-very-wrong-warn' => "'''Увага:''' функцією <code><nowiki>{{#incat:...}}</nowiki></code> {{PLURAL:$2|1=категорію $1|категорії $1}} було визначено некоректно, тому результат у попередньому перегляді може бути неправильним. Це могло бути викликаним через включення категорій усередині виразу <code><nowiki>{{#incat:...}}</nowiki></code>, що могло викликати неправильне відображення.",
);
